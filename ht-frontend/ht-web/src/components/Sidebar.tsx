...
const Sidebar: React.FC<SidebarProps> = ({ user, isOpen, onToggle, onLogout }) => {
  ...
  return (
    <>
      ...
      <div
        className={`
          h-full bg-white shadow-xl z-50 transform transition-all duration-300 ease-in-out
          ${isOpen ? 'w-64' : 'w-16'}
          ${isAutoHidden && !isHovering && isOpen ? 'w-12' : ''}
          flex-shrink-0
        `}
      ...
      >
          ...
          <ul className="space-y-2">
            ...
            <li>
              <button
                ...
                className={`
                  w-full flex items-center ${isOpen ? 'space-x-3' : 'justify-center'} px-3 py-2 rounded-md transition-colors
                  ${isActive('/') 
              ...
              >
                ...
                <span className={`${!isOpen ? 'hidden' : 'block'}`}>Chat</span>
              </button>
            </li>
              ...
              <>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className={`${!isOpen ? 'hidden' : 'block'}`}>Knowledge</span>
                  </button>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className={`${!isOpen ? 'hidden' : 'block'}`}>Organizations</span>
                  </button>
                </li>
              </>
            )}
        ...
        <div className={`absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200`}>
          <button
            ...
            className={`w-full flex items-center ${isOpen ? 'space-x-3' : 'justify-center'} px-3 py-2 text-gray-700 hover:bg-gray-50 rounded-md transition-colors`}
          >
            <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
